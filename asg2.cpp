...
int main() {
    // Hardcoded sample movie data
    vector<Movie> movies = {
        {"The Shawshank Redemption", 9.3, 1994, 2343110},
        {"The Godfather", 9.2, 1972, 1620367},
        {"The Dark Knight", 9.0, 2008, 2303232},
        {"The Godfather: Part II", 9.0, 1974, 1129952},
        {"12 Angry Men", 9.0, 1957, 689845},
        {"Schindler's List", 8.9, 1993, 1213505},
        {"The Lord of the Rings: The Return of the King", 8.9, 2003, 1642758},
        {"Pulp Fiction", 8.9, 1994, 1826188},
        {"The Lord of the Rings: The Fellowship of the Ring", 8.8, 2001, 1661481},
        {"The Good, the Bad and the Ugly", 8.8, 1966, 688390},
        {"Forrest Gump", 8.8, 1994, 1809221},
        {"Fight Club", 8.8, 1999, 1854740},
        {"Inception", 8.8, 2010, 2067042},
        {"The Lord of the Rings: The Two Towers", 8.7, 2002, 1485555},
        {"Star Wars: Episode V - The Empire Strikes Back", 8.7, 1980, 1159315},
        {"The Matrix", 8.7, 1999, 1676426},
        {"Goodfellas", 8.7, 1990, 1020727},
        {"One Flew Over the Cuckoo's Nest", 8.7, 1975, 918088},
        {"Se7en", 8.6, 1995, 1445096},
        {"Seven Samurai", 8.6, 1954, 318649},
        {"It's a Wonderful Life", 8.6, 1946, 405841},
        {"The Silence of the Lambs", 8.6, 1991, 1270197},
        {"City of God", 8.6, 2002, 699256},
        {"Saving Private Ryan", 8.6, 1998, 1250742},
        {"Life Is Beautiful", 8.6, 1997, 623629},
        {"The Green Mile", 8.6, 1999, 1147794},
        {"Star Wars: Episode IV - A New Hope", 8.6, 1977, 1231473},
        {"Terminator 2: Judgment Day", 8.5, 1991, 1000169},
        {"Back to the Future", 8.5, 1985, 1058081},
        {"Spirited Away", 8.6, 2001, 651376}
    };
